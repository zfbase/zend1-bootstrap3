 ...
 * @subpackage Form
 */
class Twitter_Bootstrap3_Form_Inlinelabel extends Twitter_Bootstrap3_Form
{
    /**
     * Disposition
     * @var integer 
     */
    protected $_disposition = self::DISPOSITION_INLINE_LABEL;
    ...
    public function getDefaultSimpleElementDecorators()
    {
        return array(
            ...
            array('Label', array(
				//Remove the following line for labels in InlineForms!
                //'class' => 'sr-only',
            )),
            array('Container'),
        );
